...
class ProductController extends RestController{
    ...
    */
	public function getCategoTitle(){
		...
		$res=\Think\Product::GetTitle($category);
		if($res){
           $data['status']=100;
           $data['value']=$res;
		}else{
    ...
    */
	public function getInfo(){
		$id=I('post.id');
		$category=I('post.catego');
		$res=\Think\Product::GetInfo($id,$category);
		if($res){
           $data['status']=100;
           $data['value']=$res;
		}else{
    ...
    */
	public function delInfo(){
		$id=I('post.id');
		$category=I('post.catego');
		$res=\Think\Product::DelInfo($id,$category);
		if($res==1){
			$data['status']=100;
		}else{
			$data['status']=101;
    ...
    */
	public function updateTitle(){
        $id=I('post.id');
		$title=I('post.title');
		$res=\Think\Product::UpdaTitle($id,$title);
		if($res==1){
			$data['status']=100;
		}else{
			$data['status']=101;
    ...
    */
	public function updateInfo(){
        ...
        $res=\Think\Product::updaInfo($id,$data,$arr,$category);
		if($res==1){
			$data['status']=100;
		}else{
			$data['status']=101;
    ...
    */
	public function AddInfo(){
        ...
        $res=\Think\Product::AddInfo($data,$arr,$category);
		if($res==1){
			$data['status']=100;
		}else{
			$data['status']=101;
